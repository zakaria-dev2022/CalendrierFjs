...
<body>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                   ...
                   {{-- <div class="nav-item dropdown">
                    ...
                    <a href="{{url('clients')}}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Clients</a>
                    <a href="{{url('calendrier')}}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Calendrier</a>
                    <a href="{{url('taches')}}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Taches</a>
    ...
    <!-- Template Javascript -->
    <script src="../resources/js/js_dash/main.js"></script>
</body>
